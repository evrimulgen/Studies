...
int main()
{
  ...
  int pere[n]={0};                              // L'arbre en largeur.
...
nbr_niv_l=ecritureNiveaux(n,niveau);
Arbre(n,nbr_niv_l,niveau,pere,arbreL,nb_arc_L);
...
parcoursProfondeur(n,voisins,pere,niveau,debut,fin);
cout << "Sommets : \t";
for(int i=0;i<n;i++)
    cout << i << "\t";
cout << endl;
