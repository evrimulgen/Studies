...
class Cellule {
 ...
 public:
  ...
  void print() const;
    ...
    Bool  estAvant(const Cellule c1,const Cellule c2)const;
    Bool  estApres(const Cellule c1,const Cellule c2)const;
    Bool  estEquivalente(const Cellule c1,const Cellule c2)const;
    Bool  estDifferente(const Cellule c1,const Cellule c2)const;
    Bool  estAvantOuEquivalente(const Cellule c1,const Cellule c2)const;
    Bool  estApresOuEquivalente(const Cellule c1,const Cellule c2)const;
